                                ...
                                <div className="col-12 mb-30" key={et}>
                                    <div className="eventsBlock">
                                        <figure className="eventsBlock__thumb">
                                            <Link onClick={ClickHandler} to={`/event-single/${events.slug}`} className="eventsBlock__thumb__link">
                                                <img src={events.eImg} alt="Gainioz Events" className="eventsBlock__thumb__image" />
                                            </Link>
                                        </figure>
                                        <div className="eventsBlock__content">
                                            <h3 className="eventsBlock__heading text-uppercase">
                                                <Link onClick={ClickHandler} to={`/event-single/${events.slug}`}>{events.title}</Link>
                                            </h3>
                                            ...
                                            <Link onClick={ClickHandler} to={`/event-single/${events.slug}`} className="eventsBlock__detailsLink">
                                                Read more
