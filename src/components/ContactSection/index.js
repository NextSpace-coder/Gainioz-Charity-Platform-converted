                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6 mb-40">
                            <div className="contactBlock text-center">
                                <figure className="contactBlock__figure">
                                    <img className="contactBlock__figure__thumb" src={icon1} alt="Gainioz Contact" />
                                </figure>
                        ...
                        <div className="col-lg-4 col-md-6 mb-40">
                            <div className="contactBlock text-center">
                                <figure className="contactBlock__figure">
                                    <img className="contactBlock__figure__thumb" src={icon2} alt="Gainioz Contact" />
                                </figure>
                                <div className="contactBlock__content">
                        ...
                        <div className="col-lg-4 col-md-6 mb-40">
                            <div className="contactBlock text-center">
                                <figure className="contactBlock__figure">
                                    <img className="contactBlock__figure__thumb" src={icon3} alt="Gainioz Contact" />
                                </figure>
                                <div className="contactBlock__content">
